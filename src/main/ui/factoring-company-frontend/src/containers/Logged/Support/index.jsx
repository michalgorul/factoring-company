        ...
        <>
            <div className="container-lg">
                <div className="text-center mt-3 mb-3">
                    <h1>Get Support</h1>
                    <p className="lead text-muted">Looking for answers? Our Support tab is where you'll find help fastest. You'll also find information on many topics</p>
                </div>
                    ...
                    <div className="col-12 col-lg-5">
                        <div className="card border-1 h-10">
                            ...
                            <div className="card-body text-center py-4 mt-2">
                                ...
                                <p className="lead card-subtitle mb-4">Submit a ticket to out support team. Our average response time is 1 hour and maximum 24 hours</p>
                    ...
                    <div className="col-12 col-lg-5">
                        <div className="card border-1">
                            ...
                            <div className="card-body text-center py-4 mt-2">
                                ...
                                <p className="lead card-subtitle mb-4">Contact support team via Live Chat. Live Chat is online at 8am to 6 pm from Monday to Friday</p>
                                {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
                                <a href="#" className="stretched-link"> </a>
                            </div>
                        </div>
