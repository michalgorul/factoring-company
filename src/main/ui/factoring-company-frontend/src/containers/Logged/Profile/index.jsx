...
const Profile = () => {
	...
	const showEditBankAccount = (bank, company) => {
		if (bank != null && company != null) {
			return (
				<a href={"/user/bank-account/edit/" + bank.id} className="text-decoration-none ml-auto h6">Edit your bank account</a>
			)
		}
		else if (bank != null && company == null) {
			return (
				<a href={"/user/profile/bank/create"} className="text-decoration-none ml-auto h6 disabled">Add your bank account</a>
			)
		}
		else if (bank == null && company != null) {
			return (
	...
	const showEditCompany = (company) => {
		if (company != null) {
			return (
				<a href={"/user/profile/company/edit/" + company.id} className="text-decoration-none ml-auto h6">Edit your company</a>
			)
		}
		else {
			return (
