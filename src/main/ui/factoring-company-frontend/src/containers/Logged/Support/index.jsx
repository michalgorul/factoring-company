            ...
            <div className="container-lg">
                <div className="text-center mt-3 mb-3">
                    ...
                    <p className="lead text-muted">Looking for answers? Our Support tab is where you'll find help fastest. You'll
                        also
                        find information on many topics</p>
                </div>
                ...
                <div className="row my-5 align-items-center justify-content-center container-fluid">
                    <div className="col-12 col-lg-5">
                        <div className="card border-1 h-10">
                            <LogoImage>
                                <img src={Ticket} className="card-img-top mt-4 mb-2" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
                                ...
                                <p className="lead card-subtitle mb-4">Submit a ticket to out support team. Our average response
                                    time
                                    is 1 hour and maximum 24 hours</p>
                    ...
                    <div className="col-12 col-lg-5">
                        <div className="card border-1">
                            <LogoImage>
                                <img src={Chat} className="card-img-top mt-4 mb-2" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
                                ...
                                <p className="lead card-subtitle mb-4">Contact support team via Live Chat. Live Chat is online at
                                    8am
                                    to 6 pm from Monday to Friday</p>
                                {/* eslint-disable-next-line jsx-a11y/anchor-is-valid */}
                                <a href="#" className="stretched-link"> </a>
                            </div>
                        </div>
                ...
                <div className="row my-5 align-items-center justify-content-center container-fluid">
                    <div className="col-12 col-lg-4">
                        <div className="card border-1 h-10">
                            <LogoImage>
                                <img src={Phone} className="card-img-top mt-4 mb-2" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
                    ...
                    <div className="col-12 col-lg-4">
                        <div className="card border-1">
                            <LogoImage>
                                <img src={Email} className="card-img-top mt-4 mb-2" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
                    ...
                    <div className="col-12 col-lg-4">
                        <div className="card border-1">
                            <LogoImage>
                                <img src={Twitter} className="card-img-top mt-4 mb-5" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
            ...
            <div className="container-lg">
                ...
                <div className="row my-5 align-items-center justify-content-center container-fluid">
                    <div className="col-12 col-lg-3">
                        <div className="card border-1 h-10">
                            <LogoImage>
                                <img src={Team1} className="card-img-top mt-4 mb-5" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
                    ...
                    <div className="col-12 col-lg-3">
                        <div className="card border-1 h-10">
                            <LogoImage>
                                <img src={Team2} className="card-img-top mt-4 mb-5" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
                    ...
                    <div className="col-12 col-lg-3">
                        <div className="card border-1 h-10">
                            <LogoImage>
                                <img src={Team3} className="card-img-top mt-4 mb-5" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
                    ...
                    <div className="col-12 col-lg-3">
                        <div className="card border-1 h-10">
                            <LogoImage>
                                <img src={Team4} className="card-img-top mt-4 mb-5" alt="..."> </img>
                            </LogoImage>
                            <div className="card-body text-center py-4 mt-2">
